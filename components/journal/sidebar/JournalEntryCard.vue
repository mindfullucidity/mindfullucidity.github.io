<template>
  <button 
    class="w-full flex flex-col items-start gap-2 rounded-lg border p-3 text-left text-sm transition-all border-border hover:bg-card max-w-lg lg:max-w-full"
